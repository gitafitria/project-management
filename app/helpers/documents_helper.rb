module DocumentsHelper
  ...
  def document_export_link(document)
    link_to 'Export', "#", class: "document-export-link btn btn-link", data: {document: document, pdf_url: download_document_pdf_path(document), email_url: download_document_email_path(document)}
  end
