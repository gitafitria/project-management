...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { content: @quotation.content, is_valid: @quotation.is_valid, project_id: @quotation.project_id, user_id: @quotation.user_id } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { content: @quotation.content, is_valid: @quotation.is_valid, project_id: @quotation.project_id, user_id: @quotation.user_id } }
